...
export default function PlacementSupportSection() {
    return (
        <section className="w-full bg-[#F5F5F5] py-8 md:py-[80px]  border-b border-gray-100 font-cabinet">
            ...
            <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-12">
                ...
                <div className="flex justify-center md:justify-end md:flex-[1.3] pr-2 md:pr-10">
                    ...
                    <div className="flex flex-col w-fit">
                        ...
                        <div
                            className="whitespace-nowrap text-[#FF5622] italic font-[500] text-[32px] sm:text-[40px] md:text-[48px] leading-[1.05] ml-[20px] sm:ml-[40px] md:ml-[100px]"
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2 mt-0 md:mt-1">
                            <div
                                className="whitespace-nowrap text-[#FF5622] italic font-[500] text-[32px] sm:text-[40px] md:text-[48px] leading-[1.05]"
                                style={{ fontFamily: "'PP Editorial New', serif" }}
                            >
                                Tech Career
                            </div>

                            <div className="whitespace-nowrap text-[#111] font-[600] text-[15px] sm:text-[16px] md:text-[18px] leading-[1.35] pt-1 sm:pt-4">
                ...
                {/* Divider 1 */}
                <div className="hidden md:block w-[1px] h-[80px] bg-gray-400/80"></div>
