...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-[92vh] flex items-center overflow-hidden bg-gradient-to-br from-[#C44A14] via-[#FF5622] to-[#E03A0A]">
      ...
      <div className="absolute bottom-[-60px] left-[-60px] w-[320px] h-[320px] rounded-full bg-[#fbbf24]/20 blur-[100px] pointer-events-none" />
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-12 py-24">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}>
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/80 text-[13px] font-medium mb-8 backdrop-blur-sm">
            <span className="w-1.5 h-1.5 rounded-full bg-[#fde68a] inline-block" />
            AI Courses
          </span>
          <h1 className="text-[48px] sm:text-[60px] md:text-[72px] lg:text-[86px] font-bold text-white leading-[1.05] tracking-tight font-cabinet mb-6">
            Generative{" "}
            <span className="text-[#fde68a] italic font-medium" style={{ fontFamily: "'PP Editorial New', serif" }}>
              AI
            </span>
          </h1>
          <p className="text-white/70 text-[18px] md:text-[20px] font-light font-cabinet max-w-[560px] leading-relaxed mb-10">
            Dive into deep learning, neural networks, LLM fine-tuning, and image generation models to build cutting-edge AI apps.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link href="/contact" className="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-[#C44A14] hover:bg-white/90 rounded-full font-semibold text-[15px] transition-all duration-300 hover:scale-105 shadow-lg">Enroll Now →</Link>
