      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-12 py-24">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <p className="text-white/70 text-[18px] md:text-[20px] font-light font-cabinet max-w-[560px] leading-relaxed mb-10">
            Understand network security, penetration testing, and security protocols to defend digital infrastructure against cyber threats.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link href="/contact" className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#FF5622] hover:bg-[#e04d1e] text-white rounded-full font-semibold text-[15px] transition-all duration-300 hover:scale-105 shadow-lg shadow-[#FF5622]/30">Enroll Now →</Link>
