...
export default function LearningMethodology() {
  return (
    <section 
      className="relative w-full bg-gradient-to-b from-[#9A7DFF] via-[#7144FE] to-[#F5F5F5] pt-16 pb-16 sm:pt-24 sm:pb-20 md:pt-32 md:pb-24 px-4 sm:px-6 md:px-12 overflow-hidden -mt-16"
      style={{
