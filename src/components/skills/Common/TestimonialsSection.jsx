...
export default function TestimonialsSection({ data }) {
    ...
    const titleNormal = data?.testimonialsSectionData?.titleNormal || "Verified Career Transitions Hear Directly";
    const titleParent = data?.testimonialsSectionData?.titleParent || "from";
