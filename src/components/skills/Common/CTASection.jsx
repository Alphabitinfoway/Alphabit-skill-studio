    ...
    <section className="w-full bg-[#F5F5F5] py-20 px-6 lg:px-20 overflow-hidden">
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-20">
        ...
        <div className="flex-shrink-0">
          <Link 
            href={buttonHref}
            className="group relative inline-flex items-center gap-2 bg-[#7143FE] text-white px-6 py-4 lg:px-10 lg:py-5 rounded-full text-[16px] lg:text-[18px] font-bold transition-all duration-300 hover:bg-[#6136e0] hover:scale-105 hover:shadow-[0_20px_40px_rgba(113,67,254,0.3)]"
          >
