// ==============================================================================
// QA Testing - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core QA Testing concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior QA Testing Developer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior QA Testing Developer",
    "QA Testing Analyst",
    "Freelance QA Testing Specialist",
    "Lead QA Testing Consultant"
],
    javaRoles: [],
};
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Qa Testing.",
...
export const ctaSectionData = {
    ...
    line2Italic: "Defect-Free Software",
...
export const metadata = {
    title: "QA Testing | Alphabit Skill",
    description: "Learn QA Testing at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
