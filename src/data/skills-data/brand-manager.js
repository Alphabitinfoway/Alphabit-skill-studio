// ==============================================================================
// Brand Manager - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Brand Manager.",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Brand Manager Associate",
        "location": "Gujarat / Hybrid",
        "salary": "₹2.5 - ₹4.5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Brand Manager Manager",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Brand Manager Associate",
    "Brand Manager Lead",
    "Strategy Planner",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Brand Manager Track",
            description: "Master the standard professional curriculum and industry tools for Brand Manager.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Brand Management",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Iconic Brands",
...
export const metadata = {
    title: "Brand Manager | Alphabit Skill",
    description: "Learn Brand Manager at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
