// ==============================================================================
// Gaming Development - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core Gaming Development concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Gaming Development Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Gaming Development Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Gaming Development Developer",
    "Gaming Development Analyst",
    "Freelance Gaming Development Specialist",
    "Lead Gaming Development Consultant"
],
    javaRoles: [],
};
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Gaming Development Track",
            description: "Master the standard professional curriculum and industry tools for Gaming Development.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Game Dev Curriculum",
...
export const metadata = {
    title: "Gaming Development | Alphabit Skill",
    description: "Learn Gaming Development at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
