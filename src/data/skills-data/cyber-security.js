// ==============================================================================
// Cyber Security - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core Cyber Security concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Cyber Security Developer",
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Cyber Security.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Cyber Security Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Secure Systems",
...
export const metadata = {
    title: "Cyber Security | Alphabit Skill",
    description: "Learn Cyber Security at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
