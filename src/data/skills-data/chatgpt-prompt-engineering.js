// ==============================================================================
// ChatGPT & Prompt Engineering - Component Data File
// Driven Dynamically for dynamic routes.
// ==============================================================================

export const heroSectionData = {
    titlePrefix: "ChatGPT & Prompt",
...
export const mernModules = [
    {
        ...
        "description": "Learn the math, data structures, and scripting concepts necessary to understand ChatGPT & Prompt Engineering.",
        "tags": [
            "Math & Logic",
            "Data Scripts",
            "AI Basics"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior AI / ChatGPT & Prompt Engineering Specialist",
        "location": "Gujarat / Remote",
        "salary": "₹4 - ₹7 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Lead AI / ChatGPT & Prompt Engineering Engineer",
...
export const careerOpportunitiesData = {
    ...
    mernRoles: [
    "AI Analyst",
    "ChatGPT & Prompt Engineering Specialist",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Chatgpt Prompt Engineering Track",
            description: "Master the standard professional curriculum and industry tools for Chatgpt Prompt Engineering.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Prompt Engineering",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "AI-Powered Outputs",
