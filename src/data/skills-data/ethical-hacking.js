// ==============================================================================
// Ethical Hacking - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core Ethical Hacking concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Ethical Hacking Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Ethical Hacking Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Ethical Hacking Developer",
    "Ethical Hacking Analyst",
    "Freelance Ethical Hacking Specialist",
    "Lead Ethical Hacking Consultant"
],
    javaRoles: [],
};
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Ethical Hacking Track",
            description: "Master the standard professional curriculum and industry tools for Ethical Hacking.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Ethical Hacking Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Penetration Testing",
