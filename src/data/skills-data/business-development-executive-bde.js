...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Business Development Executive (BDE).",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    titlePrefix: "What Professionals",
    titleItalic: "Earn",
    titleSuffix: "After Training",
    jobs: [
    {
        "title": "Junior Business Development Executive (BDE) Associate",
        "location": "Gujarat / Hybrid",
        "salary": "₹2.5 - ₹4.5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Business Development Executive (BDE) Manager",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Business Development Executive (BDE) Associate",
    "Business Development Executive (BDE) Lead",
    "Strategy Planner",
    "Business Development Executive (BDE) Coordinator"
],
    javaRoles: [],
};
    ...
    faqs: [
        {
            ...
            answer: "Yes, our programs start from the absolute basics, assuming no prior experience in the field."
        },
        {
            id: 2,
            question: "Do you provide job placement support?",
            answer: "Yes, we offer full placement assistance, including resume polishing, portfolio review, mock interviews, and partner referrals."
        }
    ]
};
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Business Development Executive Bde Track",
            description: "Master the standard professional curriculum and industry tools for Business Development Executive Bde.",
...
export const metadata = {
    title: "Business Development Executive (BDE) | Alphabit Skill",
    description: "Learn Business Development Executive (BDE) at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
