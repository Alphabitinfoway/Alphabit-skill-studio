...
export const mernModules = [
    {
        ...
        "description": "Master core Social Media Marketing concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Social Media Marketing Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Social Media Marketing Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Social Media Marketing Developer",
    "Social Media Marketing Analyst",
    "Freelance Social Media Marketing Specialist",
    "Lead Social Media Marketing Consultant"
],
    javaRoles: [],
};
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Social Media Marketing.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Social Media Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Viral Campaigns",
...
export const metadata = {
    title: "Social Media Marketing | Alphabit Skill",
    description: "Learn Social Media Marketing at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
