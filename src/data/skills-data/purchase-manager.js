...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Purchase Manager.",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Purchase Manager Associate",
        "location": "Gujarat / Hybrid",
        "salary": "₹2.5 - ₹4.5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Purchase Manager Manager",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Purchase Manager Associate",
    "Purchase Manager Lead",
    "Strategy Planner",
    "Purchase Manager Coordinator"
],
    javaRoles: [],
};
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Purchase Manager Track",
            description: "Master the standard professional curriculum and industry tools for Purchase Manager.",
...
export const metadata = {
    title: "Purchase Manager | Alphabit Skill",
    description: "Learn Purchase Manager at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
