...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Sales Executive.",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Sales Executive Associate",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Sales Executive Associate",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Sales Executive Track",
            description: "Master the standard professional curriculum and industry tools for Sales Executive.",
...
export const metadata = {
    title: "Sales Executive | Alphabit Skill",
    description: "Learn Sales Executive at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
