...
export const mernModules = [
    {
        ...
        "description": "Master core Java Development concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Java Development Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Java Development Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Java Development Developer",
    "Java Development Analyst",
    "Freelance Java Development Specialist",
    "Lead Java Development Consultant"
],
    javaRoles: [],
};
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Java Development.",
...
export const metadata = {
    title: "Java Development | Alphabit Skill",
    description: "Learn Java Development at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
