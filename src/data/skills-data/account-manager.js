...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Account Manager.",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Account Manager Associate",
        "location": "Gujarat / Hybrid",
        "salary": "₹2.5 - ₹4.5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Account Manager Manager",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Account Manager Associate",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Account Manager Track",
            description: "Master the standard professional curriculum and industry tools for Account Manager.",
...
export const metadata = {
    title: "Account Manager | Alphabit Skill",
    description: "Learn Account Manager at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
