// ==============================================================================
// .NET Development - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core .NET Development concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior .NET Development Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior .NET Development Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior .NET Development Developer",
    ".NET Development Analyst",
    "Freelance .NET Development Specialist",
    "Lead .NET Development Consultant"
],
    javaRoles: [],
};
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Net Development Track",
            description: "Master the standard professional curriculum and industry tools for Net Development.",
...
export const ctaSectionData = {
    ...
    line1Italic: ".NET Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Enterprise Solutions",
...
export const metadata = {
    title: ".NET Development | Alphabit Skill",
    description: "Learn .NET Development at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
