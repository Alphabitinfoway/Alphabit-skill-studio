// ==============================================================================
// Cloud Computing - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core Cloud Computing concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Cloud Computing Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Cloud Computing Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Cloud Computing Developer",
    "Cloud Computing Analyst",
    "Freelance Cloud Computing Specialist",
    "Lead Cloud Computing Consultant"
],
    javaRoles: [],
};
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Cloud Computing.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Cloud Computing Curriculum",
...
export const metadata = {
    title: "Cloud Computing | Alphabit Skill",
    description: "Learn Cloud Computing at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
