// ==============================================================================
// Digital Marketing Manager - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Digital Marketing Manager.",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    ...
    jobs: [
        {
            "title": "Junior Digital Marketing Manager Associate",
            "location": "Gujarat / Hybrid",
            "salary": "₹2.5 - ₹4.5 LPA",
            "badge": "Entry Level",
        },
        {
            "title": "Senior Digital Marketing Manager Manager",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
        "Junior Digital Marketing Manager Associate",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Digital Marketing Manager Track",
            description: "Master the standard professional curriculum and industry tools for Digital Marketing Manager.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Digital Marketing",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "High-Impact Campaigns",
...
export const metadata = {
    title: "Digital Marketing Manager | Alphabit Skill",
    description: "Learn Digital Marketing Manager at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
