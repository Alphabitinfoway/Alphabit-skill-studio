// ==============================================================================
// Digital Marketing - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core Digital Marketing concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Digital Marketing Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Digital Marketing Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Digital Marketing Developer",
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Digital Marketing.",
...
export const ctaSectionData = {
    ...
    line1Italic: "Digital Marketing Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Online Audiences",
