...
export const mernModules = [
    {
        ...
        "description": "Master core MERN Stack Development concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior MERN Stack Development Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior MERN Stack Development Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior MERN Stack Development Developer",
    "MERN Stack Development Analyst",
    "Freelance MERN Stack Development Specialist",
    "Lead MERN Stack Development Consultant"
],
    javaRoles: [],
};
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Mern Stack Development.",
...
export const ctaSectionData = {
    ...
    line1Italic: "MERN Stack Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Full-Stack Products",
