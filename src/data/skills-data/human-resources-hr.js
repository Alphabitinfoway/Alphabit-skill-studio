...
export const mernModules = [
    {
        ...
        "description": "Master the foundational concepts, planning guidelines, and setups required for Human Resources (HR).",
        "tags": [
            "Planning",
            "Basics",
            "Campaign Setups"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Human Resources (HR) Associate",
        "location": "Gujarat / Hybrid",
        "salary": "₹2.5 - ₹4.5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Human Resources (HR) Manager",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Human Resources (HR) Associate",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Human Resources Hr Track",
            description: "Master the standard professional curriculum and industry tools for Human Resources Hr.",
...
export const ctaSectionData = {
    ...
    line2Italic: "People & Organisations",
