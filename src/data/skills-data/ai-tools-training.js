// ==============================================================================
// AI Tools Training - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Learn the math, data structures, and scripting concepts necessary to understand AI Tools Training.",
        "tags": [
            "Math & Logic",
            "Data Scripts",
            "AI Basics"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior AI / AI Tools Training Specialist",
        "location": "Gujarat / Remote",
        "salary": "₹4 - ₹7 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Lead AI / AI Tools Training Engineer",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Ai Tools Training Track",
            description: "Master the standard professional curriculum and industry tools for Ai Tools Training.",
...
export const ctaSectionData = {
    ...
    line1Italic: "AI Tools Curriculum",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Smarter with AI",
