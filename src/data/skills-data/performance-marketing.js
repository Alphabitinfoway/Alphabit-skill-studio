// ==============================================================================
// Performance Marketing - Component Data File
...
export const mernModules = [
    {
        ...
        "description": "Master core Performance Marketing concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior Performance Marketing Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior Performance Marketing Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior Performance Marketing Developer",
    "Performance Marketing Analyst",
    "Freelance Performance Marketing Specialist",
    "Lead Performance Marketing Consultant"
],
    javaRoles: [],
};
    ...
    tracks: [
        {
            ...
            description: "Master the standard professional curriculum and industry tools for Performance Marketing.",
...
export const metadata = {
    title: "Performance Marketing | Alphabit Skill",
    description: "Learn Performance Marketing at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
