// ==============================================================================
// ROR & Odoo & Golang - Component Data File
// Driven Dynamically for dynamic routes.
// ==============================================================================

export const heroSectionData = {
    titlePrefix: "ROR & Odoo &",
    titleSuffix: "Golang",
    highlights: [
...
export const mernModules = [
    {
        ...
        "description": "Master core ROR & Odoo & Golang concepts, setting up development environments, syntax, and workflow setups.",
        "tags": [
            "Architecture",
            "Environments",
            "Core Syntax"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior ROR & Odoo & Golang Developer",
        "location": "Gujarat / Remote",
        "salary": "₹3 - ₹5 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Senior ROR & Odoo & Golang Engineer",
...
export const careerOpportunitiesData = {
    ...
    javaTitle: "",
    mernRoles: [
    "Junior ROR & Odoo & Golang Developer",
    "ROR & Odoo & Golang Analyst",
    "Freelance ROR & Odoo & Golang Specialist",
    "Lead ROR & Odoo & Golang Consultant"
],
    javaRoles: [],
};
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Ror Odoo Golang Track",
            description: "Master the standard professional curriculum and industry tools for Ror Odoo Golang.",
...
export const ctaSectionData = {
    ...
    line1Italic: "ROR, Odoo & Golang",
    line1Suffix: "- Apply Today and",
    line2Normal: "Start Building",
    line2Italic: "Backend Mastery",
...
export const metadata = {
    title: "ROR & Odoo & Golang | Alphabit Skill",
    description: "Learn ROR & Odoo & Golang at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
