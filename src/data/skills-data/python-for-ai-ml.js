...
export const mernModules = [
    {
        ...
        "description": "Learn the math, data structures, and scripting concepts necessary to understand Python for AI/ML.",
        "tags": [
            "Math & Logic",
            "Data Scripts",
            "AI Basics"
...
export const earningsSectionData = {
    ...
    jobs: [
    {
        "title": "Junior AI / Python for AI/ML Specialist",
        "location": "Gujarat / Remote",
        "salary": "₹4 - ₹7 LPA",
        "badge": "Entry Level",
    },
    {
        "title": "Lead AI / Python for AI/ML Engineer",
...
export const trackSelectorData = {
    ...
    tracks: [
        {
            title: "Python For Ai Ml Track",
            description: "Master the standard professional curriculum and industry tools for Python For Ai Ml.",
...
export const metadata = {
    title: "Python for AI/ML | Alphabit Skill",
    description: "Learn Python for AI/ML at Alphabit Skill — expert-led training, real-world projects, and placement support."
};
